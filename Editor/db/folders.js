class foldersComponent {
  ...
  async init() {
    ...
    this.render();
    this.modal = new bootstrap.Modal(document.getElementById("foldersModal"));
    this.form = document.getElementById("foldersForm");
    ...
    container.innerHTML = `
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Idx</th><th>Project_idx</th><th>Parent_idx</th><th>Name</th><th>Created_at</th><th>Updated_at</th>
                            ...
                            <tbody>
                                ${this.items.map((item) => `
                                    <tr>
                                        <td>${item.idx}</td><td>${item.project_idx}</td><td>${item.parent_idx}</td><td>${item.name}</td><td>${item.created_at}</td><td>${item.updated_at}</td>
                                        <td>
            ...
            <div class="modal fade" id="foldersModal" tabindex="-1">
                <div class="modal-dialog">
                    ...
                    <div class="form-group">
                        <label for="parent_idx">Parent_idx</label>
                        <input type="text" class="form-control" id="parent_idx" name="parent_idx" required>
                    </div>
                    <div class="form-group">
...
const foldersComponent_ = new foldersComponent();