class usersComponent {
  ...
  async init() {
    ...
    this.render();
    this.modal = new bootstrap.Modal(document.getElementById("usersModal"));
    this.form = document.getElementById("usersForm");
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    <th>Idx</th><th>Name</th><th>Id</th><th>Email</th><th>Created_at</th><th>Updated_at</th>
                            ...
                            <tbody>
                                ${this.items.map((item) => `
                                    <tr>
                                        <td>${item.idx}</td><td>${item.name}</td><td>${item.id}</td><td>${item.email}</td><td>${item.created_at}</td><td>${item.updated_at}</td>
                                        <td>
...
const usersComponent_ = new usersComponent();